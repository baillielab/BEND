...
# Code from https://github.com/navid-naderi/PLM_SWE/blob/main/model/architectures.py#L266
# Paper: Navid NaderiAlizadeh, Rohit Singh, Aggregating residue-level protein language model embeddings with optimal transport,
# Bioinformatics Advances, Volume 5, Issue 1, 2025, vbaf060, https://doi.org/10.1093/bioadv/vbaf060
############################
    ...
    def forward(self, X, mask=None, **kwargs):
        ...
        if mask is None:
            ...
            invalid_elements_mask = (
                ~mask.bool().unsqueeze(-1).repeat(1, 1, self.num_slices)
            )
