...
python3 scripts/predict_variant_effects.py $VARIANT_FILE $OUT_DIR/${OUT_PREFIX}_hyenadna_tiny1k_512.csv hyenadna LongSafari/hyenadna-tiny-1k-seqlen data/genomes/GRCh38.primary_assembly.genome.fa --extra_context 512 --embedding_idx 511 # autoreregressive
python3 scripts/predict_variant_effects.py $VARIANT_FILE $OUT_DIR/${OUT_PREFIX}_hyenadna_small32k_512.csv hyenadna LongSafari/hyenadna-small-32k-seqlen data/genomes/GRCh38.primary_assembly.genome.fa --extra_context 512 --embedding_idx 511 # autoreregressive
python3 scripts/predict_variant_effects.py $VARIANT_FILE $OUT_DIR/${OUT_PREFIX}_hyenadna_medium160k_512.csv hyenadna LongSafari/hyenadna-medium-160k-seqlen data/genomes/GRCh38.primary_assembly.genome.fa --extra_context 512 --embedding_idx 511 # autoreregressive
python3 scripts/predict_variant_effects.py $VARIANT_FILE $OUT_DIR/${OUT_PREFIX}_hyenadna_medium450k_512.csv hyenadna LongSafari/hyenadna-medium-450k-seqlen data/genomes/GRCh38.primary_assembly.genome.fa --extra_context 512 --embedding_idx 511 # autoreregressive
...
# python3 scripts/predict_variant_effects.py $VARIANT_FILE $OUT_DIR/${OUT_PREFIX}_genalm_bert_large_t2t.csv genalm AIRI-Institute/gena-lm-bert-large-t2t data/genomes/GRCh38.primary_assembly.genome.fa --embedding_idx 256
# python3 scripts/predict_variant_effects.py $VARIANT_FILE $OUT_DIR/${OUT_PREFIX}_genalm_bigbird_base_t2t.csv genalm AIRI-Institute/gena-lm-bigbird-base-t2t data/genomes/GRCh38.primary_assembly.genome.fa --embedding_idx 256
